...
public class CALOAD extends NoOperandsInstruction {
    ...
    /**
     * 从操作数栈先后pop数组索引和char数组对象，通过索引找到值压入操作数栈
    ...
    public void execute(StackFrame topStackFrame) {
        ...
        JObject charArrayObject = operandStack.popObject();
        operandStack.pushInt(((CharArrayObject) charArrayObject).getArray()[index]);

...
public class BALOAD extends NoOperandsInstruction {
    ...
    /**
     * 从操作数栈先后pop数组索引和byte数组对象，通过索引找到值压入操作数栈
    ...
    public void execute(StackFrame topStackFrame) {
        ...
        JObject byteArrayObject = operandStack.popObject();
        operandStack.pushInt(((ByteArrayObject) byteArrayObject).getArray()[index]);
